...
/// <summary>
/// Tutor authentication endpoints
/// </summary>
[Route("api/tutor")]
[ApiController]
public class TutorAuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Register([FromBody] TutorRegisterRequest request)
    {
        var command = new RegisterCommand
        {
            ...
            Role = Domain.Enums.UserRole.Tutor,
    ...
    /// <summary>
    /// Tutor Google OAuth login/register
    /// </summary>
    ...
    {
        command.Role = Domain.Enums.UserRole.Tutor;
        var result = await _mediator.Send(command);
    ...
    /// <summary>
    /// Request email verification code for signup (tutor)
    /// </summary>
    ...
    /// <summary>
    /// Confirm email verification code for signup (tutor)
    /// </summary>
    ...
    /// <summary>
    /// Resend tutor email verification
    /// </summary>
