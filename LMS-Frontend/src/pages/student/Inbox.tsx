...
import { getStudentChatRequests, ChatRequestDto } from '../../services/chatRequestsApi'
...
const StudentInbox = () => {
  ...
  useEffect(() => {
    ...
    const handleMessageReceived = (message: any) => {
      // Backend sends: { id, conversationId, senderId, content, createdAt }
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Chat with tutors and admins</p>
          </div>
          {!isConnected && (
                    ...
                    {chatRequests.map((request) => (
                      <div
                        ...
                        onClick={() => {
                          if (request.status === 'Accepted' && request.conversationId) {
                            setSelectedConversation(request.conversationId)
                          }
                        }}
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <Avatar name={request.tutorName} size="md" />
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between mb-1">
                              <h3 className="font-semibold text-gray-900 truncate">{request.tutorName}</h3>
                              <Badge
                                variant={
